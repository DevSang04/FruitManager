...
public class ShopManagement {
    ...
    public Order getChoiceFruit() {
        ...
        do {
            ...
            System.out.println(">>>[0]__Exit<<<");
            System.out.println("===============================================");
            String choice = val.getString(">Your choice(Id or name): ");
            if(choice.equalsIgnoreCase("0") || choice.equalsIgnoreCase("Exit")){   //lệnh thoát
                boolean stopLoop = val.checkInputYN( "Do you want to order now(Y/N): ");    //stopLoop == true >>> stop
                if(stopLoop == true) {
                    System.out.println("===============================================");
                    return customer;
                }
            }else if(searchFruit(choice) == null) {                           ///////
                System.out.println(">>That option doesn't exist!!");
                // cho lặp lại vòng lặp
            } else {
                Fruit frChoice = searchFruit(choice);                       ////////
                int quantityBuy = val.checkQuatityFruit(">Please input quantity(0 to exit): ", frChoice);
                
                if(quantityBuy == 0){
                    //ko làm gì cả, chạy câu hỏi Y/N
                }else if(customer.getOrder().containsKey(frChoice)) {
    ...
    ///////////////////////////////////////////////////
    public void autoGeneratedFruit() {
        listOfFruit.add(new Fruit("Lemon", 10.0, 100, "Canada"));
        listOfFruit.add(new Fruit("Orange", 15.0, 150, "Japan"));
        listOfFruit.add(new Fruit("Avocado", 14.3, 200, "Vietnam"));
        listOfFruit.add(new Fruit("Dragon fruit", 19.4, 80, "Vietnam"));
        listOfFruit.add(new Fruit("Apple", 5.5, 1000, "China"));
    }
    ///////////////////////////////////////////////////;
    ...
    public void showFruitManage() {
        ...
        for (Fruit fruit : listOfFruit) {
            System.out.printf("|  %-5d| %-16s | %-12s | %-11.2f | %-14d |\n",
